...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    exchange_rate_after_fee = exchange_rate + exchange_rate * (spread / 100)
    budget_exchanged = exchange_money(budget, exchange_rate_after_fee)
    denomination_whole = int(budget_exchanged / denomination)
    return denomination_whole * denomination
